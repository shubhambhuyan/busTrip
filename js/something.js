	...
	if(isNumber(detail)) {
		...
		for(var i = 0; i < myData.length; i++) {
			if(myData[i]["id"] === detail) {
				message = "<div class=\"col-md-4\">  <h3><font color=\"red\">Bus No. : "+myData[i]["id"]+"</font><h3></div>"+"<div class=\"col-md-4\">  <h3><font color=\"red\">Source : "+myData[i]["source"]+"</font><h3></div>"+"<div class=\"col-md-4\">  <h3><font color=\"red\">Destination : "+myData[i]["destination"]+"</font><h3></div>"+"<br><h3><font color=\"red\">Stops at these stations : <h3></div>";
				...
				message = message + "<br>  <section id=\"explore\"> <div class=\"container\"><div class=\"row\"><div class=\"watch\"><img class=\"img-responsive\" src=\"images/watch.png\"></div><div class=\"col-md-4 col-md-offset-2 col-sm-5\"><h2><font color=\"white\">WE HOPE YOU DON'T HAVE TO WAIT FOR LONG</font></h2></div><br><br><br><br></div></div></section>";
				break;
			}
		}
		if(message.length == 0)
...
function exampleSearch() {
	document.getElementById("busdetail").innerHTML = "<section id=\"output\"><div class=\"container\"><br><br><br><br><br><br><br>"+searchBusDetails(document.getElementById("busDetail").value)+ "</section></div>";
}
...
function wrapperTripPlanner() {
	document.getElementById("tripdetails").innerHTML = "<section id=\"output\"><div class=\"container\"><br><br><br><br><br><br><br>"+tripPlanner(document.getElementById("tripPlannerSource").value, document.getElementById("tripPlannerDestination").value)+"</section></div>";
}
